...
var mangaArr=[["image/onePunch.jpg"," One punch manga"
				,"7.00","fstfd"],
			["image/dragonBall.jpg","Dragon Ball manga"
				,"6.00","scdfd"]];

/* showing data with for statement*/
$( document ).ready(function() {
	jQuery.each( mangaArr, function( i, val ) {
	  $("#mangaDiv").append('<div class="mangalist" id='+val[3]+'><img src="'+val[0]+'"><br/>'
		+'<h5>'+val[1]+'</h5>'+'$'+val[2]
